  ...
  <Html>
    ...
    <Body style={{ backgroundColor: "white" }}>
      ...
      >
        ...
        >
          <strong>{commenterName}</strong> comentó en la tarjeta{" "}
          <strong>{cardTitle}</strong> del tablero{" "}
        ...
        >
          <Text style={{ fontSize: "0.875rem", margin: 0, color: BRAND_NAVY }}>
            {commentExcerpt}
          </Text>
        </Container>
        <Button
